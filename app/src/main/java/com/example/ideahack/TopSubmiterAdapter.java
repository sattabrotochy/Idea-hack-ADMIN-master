...
public class TopSubmiterAdapter extends BaseAdapter {
    ...
    public TopSubmiterAdapter(Context context, List<UserModel> listModelList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        point.setText(String.valueOf(listModelList.get(i).getSubmit()));
